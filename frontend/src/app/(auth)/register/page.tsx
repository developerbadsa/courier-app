          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6 sm:p-8 space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full h-10 px-3 text-sm bg-white border rounded-lg text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 ${errors.businessName ? 'border-red-400 focus:border-red-500 focus:ring-red-500/10' : 'border-slate-200 focus:border-blue-500 focus:ring-blue-500/10'}`}
              />
            ...
            <div>
              ...
              <select
                ...
                className={`w-full h-10 px-3 text-sm bg-white border rounded-lg text-slate-900 focus:outline-none focus:ring-2 ${errors.businessType ? 'border-red-400' : 'border-slate-200 focus:border-blue-500 focus:ring-blue-500/10'}`}
              >
            ...
            <div>
              ...
              <input
                ...
                className={`w-full h-10 px-3 text-sm bg-white border rounded-lg text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 ${errors.contactPerson ? 'border-red-400' : 'border-slate-200 focus:border-blue-500 focus:ring-blue-500/10'}`}
              />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full h-10 px-3 text-sm bg-white border rounded-lg text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 ${errors.phone ? 'border-red-400' : 'border-slate-200 focus:border-blue-500 focus:ring-blue-500/10'}`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full h-10 px-3 text-sm bg-white border rounded-lg text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 ${errors.email ? 'border-red-400' : 'border-slate-200 focus:border-blue-500 focus:ring-blue-500/10'}`}
                />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full h-10 px-3 text-sm bg-white border rounded-lg text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 ${errors.password ? 'border-red-400' : 'border-slate-200 focus:border-blue-500 focus:ring-blue-500/10'}`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full h-10 px-3 text-sm bg-white border rounded-lg text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 ${errors.confirmPassword ? 'border-red-400' : 'border-slate-200 focus:border-blue-500 focus:ring-blue-500/10'}`}
                />
            ...
            <div className="flex justify-end pt-2">
              <button
                onClick={handleNext}
                className="flex items-center gap-2 px-6 py-2.5 text-sm font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors"
              >
        ...
        {step === 2 && (
          <div className="bg-white rounded-xl border border-slate-200 p-6 sm:p-8 space-y-5">
            ...
            <div>
              ...
              <label className={`flex items-center justify-center gap-3 p-6 border-2 border-dashed rounded-xl cursor-pointer transition-colors ${errors.nidFront ? 'border-red-400 bg-red-50' : form.nidFront ? 'border-emerald-400 bg-emerald-50' : 'border-slate-300 hover:border-slate-400 bg-slate-50'}`}>
            ...
            <div>
              ...
              <label className={`flex items-center justify-center gap-3 p-6 border-2 border-dashed rounded-xl cursor-pointer transition-colors ${errors.nidBack ? 'border-red-400 bg-red-50' : form.nidBack ? 'border-emerald-400 bg-emerald-50' : 'border-slate-300 hover:border-slate-400 bg-slate-50'}`}>
            ...
            <div>
              ...
              <label className="flex items-center justify-center gap-3 p-6 border-2 border-dashed border-slate-300 hover:border-slate-400 bg-slate-50 rounded-xl cursor-pointer transition-colors">
            ...
            <div className="flex justify-between pt-2">
              <button
                onClick={() => setStep(1)}
                className="flex items-center gap-2 px-4 py-2.5 text-sm font-semibold text-slate-600 bg-white border border-slate-200 rounded-lg hover:bg-slate-50"
              >
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-6 sm:p-8 space-y-5">
            ...
            <div className="flex justify-between pt-2">
              ...
              <button
                ...
                disabled={submitting}
                className="flex items-center gap-2 px-6 py-2.5 text-sm font-semibold text-white bg-emerald-600 rounded-lg hover:bg-emerald-700 disabled:opacity-50 transition-colors"
              >
