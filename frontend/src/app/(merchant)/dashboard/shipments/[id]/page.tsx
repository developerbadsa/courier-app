      ...
      <div className="space-y-6 max-w-7xl mx-auto font-sans">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-5 space-y-5">
            ...
            <div className="bg-[#EEF4FF]/70 border border-[#D8E6FF] rounded-2xl p-6 space-y-4.5 shadow-xs">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="bg-white border border-slate-200/90 text-slate-800 text-xs font-bold px-3 py-1 rounded-lg shadow-2xs">
                    COD: $15.00
                  </span>
                </div>
              </div>
            ...
            <div className="bg-[#EEF4FF]/70 border border-[#D8E6FF] rounded-2xl p-5 shadow-xs">
              <h2 className="text-sm font-bold text-slate-900 mb-3.5">
                Rider Assignment
              </h2>

              <div className="flex items-center gap-3.5 bg-white/70 border border-slate-200/60 rounded-xl p-3">
            ...
            <div className="bg-white border border-slate-200/90 rounded-2xl p-6 sm:p-7 shadow-xs">
              ...
              <div className="flex items-center justify-between pb-6 border-b border-slate-100">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 bg-[#EEF4FF] hover:bg-blue-100 text-blue-700 text-xs font-bold px-3.5 py-2 rounded-lg border border-[#D8E6FF] transition-colors cursor-pointer shadow-2xs"
                >
              ...
              <div className="mt-7 relative pl-3 sm:pl-4 space-y-8">
                ...
                {notes.map((note, idx) => (
                  <div key={idx} className="relative flex items-start gap-4.5 pt-2">
                    ...
                    <div className="bg-slate-50 border border-slate-200 rounded-xl p-3 flex-1 text-xs">
            ...
            <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl border border-slate-200 space-y-4">
              ...
              <form onSubmit={handleAddNote} className="space-y-4">
                <textarea
                  ...
                  className="w-full text-xs p-3 border border-slate-300 rounded-lg focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-600/15"
                />
